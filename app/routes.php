...
$app->group('/api/v1', function () {
	...
	$this->get('/FormHeader/compute', 'ProfPortfolio\Controllers\FormHeaderController:compute');
	$this->get('/FormHeader/IndicatorCompute', 'ProfPortfolio\Controllers\FormHeaderController:IndicatorCompute');
